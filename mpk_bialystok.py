...
from implementation.commons.generation_util import print_list_str, get_page_content
from implementation.commons.search_util import find_all_attribute_matching_or_error, find_all_containing_values_or_error
...
if __name__ == '__main__':
    ...
    print_list_str(mpk_bialystok.get_transit_agency_name(), mpk_bialystok.errors)
